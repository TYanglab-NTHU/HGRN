...
import sys
# sys.path.append('/work/u5066474/NTHU/LiveTransForM-main/EGNN-main')
...
if __name__ == '__main__':
    ...
    parser.add_option("--i_organic", dest="input_organic", default='test_data.csv')
    ...
    parser.add_option("--output_size", dest="output_size", type=int, default=5)
